...
export const openAcctState = (mongo_db, mongo_collection, mongo_uri, path) => {
            ...
            for (let i = 0; i < recordsWithoutHeader.length; i++) {
                ...
                updateArray.push({
                    updateOne: {
                        ...
                        update: {
                            $set: {
                                "account.open_account.state": "ACCOUNT_APPROVED",
                                "account.open_account.updated_at": doc["updated_at"],
                            }
                        },
                    },
                });
